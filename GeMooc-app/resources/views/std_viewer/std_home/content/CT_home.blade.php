            ...
            <div class="col-md-3">
                <div class="card" style="width: 11rem;">
                    ...
                    <div class="progress" style="height: 10px;">
                        <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: {{(int)($sum_course)}}%"
                            aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">name</h5>
                        <a href="{{ url("std_view/course/1") }}" target="_blank" class="btn btn-primary btn-sm">Get started</a>
                    </div>
                </div>
            </div>
            @endforeach
