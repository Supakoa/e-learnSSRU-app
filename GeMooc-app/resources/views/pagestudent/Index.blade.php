...
<nav class="navbar navbar-expand-lg navbar-light" id="studentNav">
    <a class="navbar-brand p-0 ml-5" href="#">
        <img src="{{url('images/01.png')}}" width="150px" height="100px" class="m-0 p-0" alt="">
    </a>
    <script>
            ...
            <div class="container offset-xl-3">
                <ul class="navbar-nav">
                    <li class="dropdown" style="display:flex;">
                        ...
                        @endif
                        <a class="nav-link dropdown-toggle align-middle mr-5 pr-5" href="#" id="navbarDropdown" role="button"
