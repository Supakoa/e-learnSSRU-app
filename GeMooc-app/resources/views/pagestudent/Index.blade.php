...
<nav class="navbar navbar-expand-lg navbar-light pl-3 pr-3 pt-0 pb-2" id="studentNav">
    ...
    <div class="collapse navbar-collapse w-100" id="navbarNav">
        <ul class="navbar-nav justify-content-lg-start w-100">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('std_view/subject')}}">วิชา</a>
            </li>
            <li class="nav-item">
        ...
        <div class="form-inline w-50 mr-3 ml-0">
            <div class="pl-0 container offset-xl-3">
                <ul class="navbar-nav">
                    <li class="dropdown align-middle ml-0" style="display:flex;">
                        @if (auth()->user()->profile->image!=null)
                        <a href="{{url('std_view/home')}}">
                            <img  class=" align-middle ml-0 mb-0" src="{{url('/storage/'.auth()->user()->profile->image) }}" id="imageProfile" alt="...">
                        </a>
                        @else
                        <a href="{{url('std_view/home')}}">
                            <img class=" align-middle ml-0 mb-0"
                        ...
                        @endif
                        <a class="nav-link dropdown-toggle align-middle mt-1 mr-5 pr-5" href="#" id="navbarDropdown" role="button"
