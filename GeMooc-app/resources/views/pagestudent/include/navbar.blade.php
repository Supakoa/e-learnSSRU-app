<nav class="navbar navbar-expand-lg navbar-light " style="z-index:99">
    <a class="navbar-brand" href="{{url('std_view/home')}}">
        {{-- GE Logo brand --}}
        <img src="{{url('images/01.png')}}" class="d-inline-block align-top " width="80" height="80" alt="">
    </a>
    <script>
    ...
    <a href="{{url('std_view/home')}}">
        <img  class="rounded-circle" src="{{url('/storage/'.auth()->user()->profile->image) }}" width="40" height="40" id="imageProfile" alt="...">
    </a>
    @else
    <a href="{{url('std_view/home')}}">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
        <a class="dropdown-item " href="{{url('std_view/profile')}}"><i class="fas fa-user-alt"></i> แก้ไขโปรไฟล์</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="#" onclick="$('#logout-form').submit()"><i class="fas fa-sign-out-alt"></i> ออกจากระบบ</a>
