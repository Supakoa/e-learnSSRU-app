...
<div class="containerContent">
    <div class="sectionQuiz">
        <ul class=" text-center">
            ...
            <li><a class=" pageChoice " data-toggle="collapse" href="#choice1" role="button" aria-expanded="true"
                    aria-controls="choice1">1</a></li>
            <li><a class=" pageChoice collapsed" data-toggle="collapse" href="#choice2" role="button" aria-expanded="false"
                    aria-controls="choice2">2</a></li>
            <li><a class=" pageChoice collapsed" data-toggle="collapse" href="#choice3" role="button" aria-expanded="false"
                    aria-controls="choice3">3</a></li>
        ...
        <div class="container mt-3">
            <div class="card collapse show" id="choice1">
                <div class="row">
                    <div class="col-md-12 ">
            ...
            <div class="card collapse" id="choice2">
                <div class="row">
                    <div class="col-md-12 ">
                        <p class="p-1 text-right">1/10</p>
                    </div>
            ...
            <div class="card collapse" id="choice3" >
                    <div class="row">
                        <div class="col-md-12 ">
                            <p class="p-1 text-right">1/10</p>
                        </div>
