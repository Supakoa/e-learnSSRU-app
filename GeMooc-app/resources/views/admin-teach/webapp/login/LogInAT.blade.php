...
<div class="container-fluid justify-content-center">
    <div class="container w-100" style="max-width:550px">
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <div class="forms-title">
                <img class="img-responsive" src="{{url('images/newLogoborder.png')}}"  alt="">
            </div>
            <div class="forms-body">
                ...
                <div class="forms-footer w-100 p-2 justify-content-center">
                    <button class="btn w-50" type="submit">เข้าสู่ระบบ</button>
                </div>
                <div class="forms-body-footer m-1">
